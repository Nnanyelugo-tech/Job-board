...
export default function Header() {
  ...
  return(
    <header className="relative bg-linear-to-r from-slate-900 via-emerald-950 to-slate-900 text-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-5 flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-3 group">
         <div className="w-11 h-11 rounded-xl bg-emerald-600 flex items-center justify-center shadow-lg shadow-emerald-600/30 group-hover:scale-105 transition-transform">
          ...
          <Link to="/jobs" className="text-white/80 hover:text-white transition">
            Jobs
          </Link>
          <Link
            to="/admin"
      ...
      transform transition-transform duration-300 ${open ? "translate-x-0" 
      : "translate-x-full"}`}>
...
// export default function Header() {
//   return (
//     <header className="relative bg-linear-to-r from-slate-900 via-emerald-950 to-slate-900 text-white p-6 overflow-hidden">
//       {/* Background Glow Effects */}
//       <div className="absolute inset-0 pointer-events-none">
//         <div className="absolute top-0 left-0 w-64 h-64 bg-emerald-400/10 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2" />
//         <div className="absolute top-0 right-0 w-64 h-64 bg-cyan-400/10 rounded-full blur-3xl translate-x-1/2 -translate-y-1/2" />
//       </div>

//       <div className="relative max-w-6xl mx-auto flex justify-between items-center">
//         <div>
//           <h1 className="text-2xl font-bold text-white">HireCore Recruitment Board</h1>
//           <p className="text-sm text-white/70">Medical & Industrial Gas Production</p>
//         </div>

//         <nav className="space-x-6 text-sm">
//           <Link to="/" className="text-white/90 hover:text-white transition-colors duration-200">
//             Home
//           </Link>
//           <Link to="/jobs" className="text-white/90 hover:text-white transition-colors duration-200">
//             Jobs
//           </Link>
//           <Link to="/admin" className="text-white/90 hover:text-white transition-colors duration-200">
//             Admin
//           </Link>
//         </nav>
//       </div>
